...
class EditorEventFabric : public EventFabric {
 public:
  std::unique_ptr<Event> getKeyPressEvent(int key, int scancode,
                                          int mods) override;
  std::unique_ptr<Event> getKeyReleaseEvent(int key, int scancode,
                                            int mods) override;
  std::unique_ptr<Event> getKeyRepeatEvent(int key, int scancode,
                                           int mods) override;
  ...
  std::unique_ptr<Event> getMousePressedEvent(int button, int action,
                                              int mods) override;
  std::unique_ptr<Event> getMousePressedEvent(QMouseEvent* event);
  std::unique_ptr<Event> getMouseReleasedEvent(int button, int action,
                                               int mods) override;
